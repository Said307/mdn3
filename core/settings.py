...
SECRET_KEY = 'o6hc9w9=aothi69uu^z^^ko(74ltv0tdj_yv%6##zb@syxbyg+'
...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles',
     'rest_framework',
    'rest_framework.authtoken','product','users.apps.UsersConfig',
]
...
STATICFILES_DIRS = (os.path.join(BASE_DIR, "staticfiles"),)  # additional static files 
